...
const Sidebar = ({ activePath }) => {
  return (
    <nav className="fixed top-0 left-0 h-screen w-56 bg-pink-600 shadow-2xl z-10 p-4">
      <div className="flex flex-col h-full">
        {/* Brand Name (EVOL) */}
        <div className="text-center mb-10 pb-4 border-b border-pink-400">
          <h1 className="text-white text-3xl font-extrabold tracking-widest leading-none">
            EVOL
          </h1>
          <p
            className="bg-gradient-to-r from-pink-200 via-white to-pink-200 text-transparent bg-clip-text
               text-sm  font-semibold mt-2 tracking-[0.15em] animate-pulse"
          >
            Every Vibe of Life
          </p>
        </div>
            ...
            <Link
              ...
              className={`
                    ...
                    ${
                      ...
                      (item.path === "/" && activePath === "") // Special check for the root path
