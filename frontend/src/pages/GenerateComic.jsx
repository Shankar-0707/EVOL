        ...
        <div className="min-h-full">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100 max-w-2xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="theme" className="block text-gray-700 font-bold mb-2">Key Moment / Comic Theme</label>
                        <textarea
                            id="theme"
                            value={theme}
                            ...
                            disabled={isLoading}
                        />
                        <p className="text-xs text-gray-500 mt-2">Be specific! The AI will turn this into a short, romantic comic strip dialogue.</p>
                    </div>
