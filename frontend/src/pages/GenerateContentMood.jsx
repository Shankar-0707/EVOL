  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message =
        ...
        "Failed to generate content. Check your Gemini API key.";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label
              ...
              className="block text-gray-700 font-bold mb-2"
            >
              2. What Should the AI Create?
            </label>
            <div className="flex space-x-4">
              <motion.button
                type="button"
                onClick={() => setPromptType("Poem")}
                className={`w-1/2 py-3 rounded-xl font-bold transition duration-150 ${
                  promptType === "Poem"
