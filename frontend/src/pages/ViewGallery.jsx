        ...
        if (isLoading) {
            return (
                <div className="text-center py-16 text-teal-500">
                    ...
                    <p className="text-lg font-medium">Loading your beautiful gallery...</p>
                </div>
            );
        }
        ...
        <div className="min-h-full relative overflow-hidden">
            ...
            <motion.div
                ...
                style={{
                    ...
                    background: `radial-gradient(400px at ${mousePosition.x * 20 + 50}% ${mousePosition.y * 20 + 50}%, rgba(0, 150, 136, 0.15) 0%, rgba(255, 255, 255, 0) 100%)`,
                            ...
                            >
                                <div className="relative w-full h-64">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent p-4 flex flex-col justify-end">
                                        <p className="text-white text-lg font-semibold line-clamp-2">{photo.caption}</p>
                                    </div>
                                </div>

                                <div className="p-4 flex justify-between items-center">
                                    <p className="text-xs text-gray-500">
                                        By: <span className="font-semibold text-teal-600">{photo.uploadedBy}</span> on {formatDate(photo.uploadedAt)}
                                    </p>
                                     <button
